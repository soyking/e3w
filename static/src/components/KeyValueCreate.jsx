        ...
        return (
            <Box vertical>
                ...
                <Box>
                    {
                        canClick ?
                            (<div><Button type="primary" onClick={this._createKey } >Create Key</Button>
                                <Button type="primary" onClick={this._createDir } >Create Dir</Button></div>) :
                            (<div><Button type="primary" onClick={this._createKey } disabled >Create Key</Button>
                                <Button type="primary" onClick={this._createDir } disabled>Create Dir</Button></div>)
                    }
                </Box>
            </Box>
        )
